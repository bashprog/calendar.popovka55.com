            ...
            <React.Fragment>
                ...
                >
                    ...
                    <div className={classes.footer}>
                        <ListAltIcon className={classes.footerIcon + `${tableView ? ' active' : ""}`} onClick={() => toggleTableView(true)}/>
                        <AppsIcon className={classes.footerIcon + `${!tableView ? ' active' : ""}`} onClick={() => toggleTableView(false)}/>
                    </div>
                </SwipeableDrawer>
            </React.Fragment>
        </div>
